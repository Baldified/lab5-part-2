...
public class Responder
{
    ...
    {
        int z = randomGenerator.nextInt(ohYeah.size());
         while(z == y){
            z = randomGenerator.nextInt(ohYeah.size());
        }
        y = z;
        return ohYeah.get(z);
    ...
    {
        ohYeah.put(1, "Default message 1");
        ohYeah.put(2, "Default message 2");
        ohYeah.put(3, "Default message 3");
    }
}
